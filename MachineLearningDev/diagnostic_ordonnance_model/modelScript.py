...
class KNNModel:
    ...
    BASE_PATH = "diagnostic_ordonnance_model/modeldata/"
    ...
    def preprocessData(self,inputData)->np.ndarray:
        descriptionsTokenized = inputData['Description'].apply(lambda x: self.tokenizeText(x))
    ...
    def predict(self,inputData):
        ...
        distances, indices = self.model.kneighbors(preproccedData, n_neighbors=10)
        # just unique
...
input = pd.read_csv("diagnostic_ordonnance_model/validation.csv")
